        ...
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <button
            ...
            className={classNames('h-8 px-4 text-center text-sm capitalize ', {
              'bg-green-500 text-white hover:bg-green-500/80': isActiveSortBy(view),
          ...
          <button
            ...
            className={classNames('h-8 px-4 text-center text-sm capitalize ', {
              'bg-green-500 text-white hover:bg-green-500/80': isActiveSortBy(createdAt),
          ...
          <button
            ...
            className={classNames('h-8 px-4 text-center text-sm capitalize', {
              'bg-green-500 text-white hover:bg-green-500/80': isActiveSortBy(sold),
          ...
          <select
            ...
            className={classNames('h-8  px-4 text-left text-sm capitalize  outline-none ', {
              'bg-green-500 text-white hover:bg-green-500/80': isActiveSortBy(price),
