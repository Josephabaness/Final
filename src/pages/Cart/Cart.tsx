        ...
        {extendedPurchases.length > 0 ? (
          <>
                          ...
                          <div className='grid grid-cols-5 items-center'>
                            ...
                            <div className='col-span-1'>
                              <button
                                ...
                                className='bg-none text-black transition-colors hover:text-green-500'
                              >
                                Delete
                              </button>
                            </div>
            ...
            <div className='sticky bottom-0 z-10 mt-8 flex flex-col rounded-sm border border-gray-100 bg-white p-5 shadow sm:flex-row sm:items-center'>
              <div className='flex items-center'>
                ...
                <button className='mx-3 border-none bg-none hover:text-green-500' onClick={handleDeleteManyPurchases}>
                  Delete
                </button>
              </div>
              ...
              <div className='mt-5 flex flex-col sm:ml-auto sm:mt-0 sm:flex-row sm:items-center'>
                <div>
                  <div className='flex items-center sm:justify-end'>
                    ...
                    <div className='ml-2 text-2xl text-green-500'>${formatCurrency(totalCheckedPurchasePrice)}</div>
                  </div>
                  <div className='flex items-center text-sm sm:justify-end'>
                    <div className='text-gray-500'>Save</div>
                    <div className='ml-6 text-green-500'>${formatCurrency(totalCheckedPurchaseSavingPrice)}</div>
                  </div>
                </div>
                <Button
          ...
          <div className='text-center'>
            ...
            <div className='mt-5 text-center'>
              <Link
                to={path.home}
                className=' rounded-sm bg-green-500 px-10 py-2  uppercase text-white transition-all hover:bg-green-500/80'
              >
                Go Shopping Now
              </Link>
            </div>
