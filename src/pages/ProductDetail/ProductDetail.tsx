                ...
                {currentImages.map((img) => {
                  ...
                  return (
                    <div className='relative w-full pt-[100%]' key={img} onMouseEnter={() => chooseActive(img)}>
                      ...
                      />
                      {isActive && <div className='absolute inset-0 border-2 border-green-500' />}
                    </div>
                  );
                })}
                <button
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                <div className='flex items-center'>
                  <span className='mr-1 border-b border-b-green-500 text-green-500'>{product.rating}</span>
                  <ProductRating
                    rating={product.rating}
                    activeClassname='fill-green-500 text-green-500 h-4 w-4'
              ...
              <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
                ...
                <div className='ml-3 text-3xl font-medium text-green-500'>${formatCurrency(product.price)}</div>
                <div className='ml-4 rounded-sm bg-green-500 px-1 py-[2px] text-xs font-semibold uppercase text-white'>
              ...
              <div className='mt-8 flex items-center'>
                <button
                  onClick={addToCart}
                  className='flex h-12 items-center justify-center rounded-sm border border-green-500 bg-green-500/10 px-5 capitalize text-green-500 shadow-sm hover:bg-green-500/5'
                >
                  <svg
                    ...
                    x={0}
                    y={0}
                    className='mr-[10px] h-5 w-5 fill-current stroke-green-500 text-green-500'
                  >
                    <g>
                      <g>
                        <polyline
                ...
                <button
                  onClick={buyNow}
                  className='fkex ml-4 h-12 min-w-[5rem] items-center justify-center rounded-sm bg-green-500 px-5 capitalize text-white shadow-sm outline-none hover:bg-green-500/90'
                >
                  Buy Now
                </button>
              </div>
